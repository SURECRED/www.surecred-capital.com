...
<head>
    ...
    <title> SureCred Employee Management System</title>
        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3">SureCred Capital Employee Management System </h2>
                 </div>
                ...
                <ul class="metismenu" id="menu">
                   <br> <br>       
                    ...
                    <li>
                        ...
                        <li>
                        <a href="http://localhost/surecred%20chat%20app/login.php" >
                            <i class="material-design-iconic-font"><span class="nav-text">Chat</span>
                        </a>
                    </li>      
                        <li>
                        <a href="./logout.php" >
