...
<html lang="en">
  <head>
    ...
    <title>SureCred Capital Employee Management System</title>
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-5">
                            <div class="card-body shadow">   
                                    ...
                                    <h2 class="text-center pb-4">SureCred Capital Employee Management System</h2>
<li>
                        <a href="http://localhost/Suggestion%20box" ><span style="font-size: 50px;"> 
                            <i class="material-design-iconic-font"><span class="nav-text"><marquee>SureCred Capital Suggestion Box</marquee></span>
                        </a>
                    </li>   
